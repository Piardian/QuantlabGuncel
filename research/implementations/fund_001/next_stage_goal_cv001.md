...
Evaluate whether implemented FUND-001 is a valid, stable, reproducible, and internally consistent implementation of the frozen Funding Stress construct.
...
1. Does FUND-001 produce coherent funding-stress state measurements?
2. Is the raw spread internally interpretable through time?
...
CV-001 must classify FUND-001 as one of:
