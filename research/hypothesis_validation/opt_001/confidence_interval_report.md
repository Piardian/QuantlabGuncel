...
Bootstrap confidence intervals were computed for high-vs-low state mean differences using a fixed random seed.
...
For the quantitative hypotheses, confidence intervals are directionally consistent with the preregistered mechanism hypotheses.
