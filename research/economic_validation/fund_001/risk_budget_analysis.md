...
UC-1 evaluates fixed funding-stress-aware risk budgeting against a static 0.75 exposure benchmark.
...
See `use_case_classifications.csv` for final UC-1 classification.
