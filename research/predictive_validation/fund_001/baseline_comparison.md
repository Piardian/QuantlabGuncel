...
The predefined null model is a no-information baseline:
...
Positive IC values indicate that higher current FUND-001 readings are associated with higher future risk targets. Negative IC values indicate inverse association. These are predictive validity statistics only, not economic value statistics.
